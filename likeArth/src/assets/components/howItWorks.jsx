...
export default function HowItWorks(){
    const visions = [
        ...
        { id: 2, img: Works2, title: 'Submit Your Task', desc: 'Have a project in mind? Simply submit your task details through our easy-to-use platform. Be as detailed as possible to help us understand your vision.', style: 'mt-0 xl:mt-[2.5rem]', delay:"900" },
        ...
        { id: 4, img: Works4, title: 'Handoff & Documentation', desc: 'Once you’re happy with the final design, we’ll hand over all the files you need. Enjoy your new, professionally crafted design!', style: 'mt-0 xl:mt-[2.5rem]', delay:"1300" }
    ];
    const tab_1visions = [
                ...
                <div className='container mx-auto max-w-[1120px]'>
                    <div className="howItWorks-box flex flex-col justify-center items-center py-[4.773rem]">
                        ...
                        <div className="flex flex-col justify-center items-center gap-[1.5rem] relative z-10">
                            ...
                            <p data-aos="fade-up" data-aos-once="true" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-delay="600" className="text-[1.25rem] font-semibold leading-[28px] text-center">From Concept to Creation, Made Simple.</p>
                        </div>
                        {/* bawah */}
                            ...
                            {visions.map (vision => (
                                <div key={vision.id} className="flex flex-col items-center justify-center gap-[1rem]">
                                    <figure data-aos="fade-up" data-aos-once="true" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-delay={vision.delay} className={vision.style}>
                                        <img src={vision.img} alt="" className='h-full w-full object-cover'/>
                                    </figure>
