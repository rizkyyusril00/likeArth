...
export default function Accordion({title, isi, delay}){
    ...
    return(
        <>
            <div data-aos="fade-up" data-aos-once="true" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-delay={delay} onClick={() => setAccordionOpen(!accordionOpen)} className="bg-transparent cursor-pointer py-4 xl:py-0 relative z-20 border-b-2 border-white">
                {/* Button accordion */}
