                ...
                <div className="container mx-auto max-w-[1120px]">
                    <div className="hero-box flex flex-col items-center justify-center gap-[1rem]">
                        <div className="flex flex-col items-center justify-center gap-[1.5rem] md:gap-[1rem]">
                            {/* tagline */}
                            <motion.h1 className="text-primary text-[3.5rem] xl:text-[4rem] leading-tight xl:leading-[72px] text-center font-bold">
                        ...
                        {/* contact us */}
                        <motion.div whileInView={{opacity: [0, 1]}} transition={{delay: 2.5, duration: 1, ease: "easeInOut" }} viewport={{ once: true }} className="px-7 sm:px-[58px] md:px-[165px] lg:px-[280px] xl:px-[270px] container mx-auto max-w-[1120px] hidden md:flex items-center justify-center">
                            <motion.div whileInView={{width: widthAnimation}} transition={{delay: 2.4, duration: 1.5, ease: "easeInOut" }} viewport={{ once: true }} className="bg-white rounded-[0.938rem] pl-[17px] py-1 xl:py-0 justify-between items-center flex relative z-10 overflow-hidden">
                                ...
                                <motion.div whileInView={{opacity: [0, 1]}} transition={{delay: 2.8, duration: 1, ease: "easeInOut" }} viewport={{ once: true }} className='flex items-center justify-center absolute left-[17px] gap-[10px]'>
                                    ...
                                    <motion.p whileInView={{opacity: [0, 1], fontSize: ['0.1rem', '0.875rem'] }} transition={{delay: 2.2, duration: 1, ease: "easeInOut" }} viewport={{ once: true }} className=' leading-[28px]'><span className="text-primary">1 Slot available!</span> <span className='hidden md:inline-block text-[#676767]'>Let's talk</span> <span className='hidden xl:inline-block text-[#676767]'>to get your project started.</span></motion.p>
                                </motion.div>
                                {/* icon pulse */}
                                ...
                                <motion.a href="https://cal.com/likearthstudio/30min" target='_blank' className='py-[10px] md:py-[17px] xl:py-[13px] w-[100px] md:w-[170px] text-center text-white text-[0.875rem] bg-primary hover:bg-[#04525b] transition-all duration-500 ease-in-out rounded-[0.938rem] absolute right-0 z-30'>Book a Call</motion.a>
                            </motion.div>
                        </motion.div>
                        {/* contack us mobile */}
                        <motion.div whileInView={{y: [25, 0] }} transition={{delay: 0.9, duration: 1.5, ease: "easeInOut" }} viewport={{ once: false }} className='flex md:hidden justify-center items-center'>
                            <motion.div whileInView={{opacity: [0, 1] }} transition={{delay: 1, duration: 1.5, ease: "easeInOut" }} viewport={{ once: false }} className="flex items-center justify-center gap-1 md:gap-4 xl:gap-[0.625rem] bg-white pl-[0.75rem] rounded-[0.938rem] relative w-auto transition-all duration-500 ease-in-out">
                                <div className='flex items-center justify-center gap-[0.625rem]'>
                                    ...
                                    {/*attention */}
                                    <motion.p  whileInView={{opacity: [0, 1], fontSize: ['0.1rem', '0.875rem'] }} transition={{delay: 2.2, duration: 1, ease: "easeInOut" }} viewport={{ once: false }} className='py-[0.1rem] md:py-[0.6rem] leading-[28px] mr-2'><span className="text-primary">1 Slot available!</span> <span className='hidden md:inline-block text-[#676767]'>Let's talk</span> <span className='hidden xl:inline-block text-[#676767]'>to get your project started.</span></motion.p>
                                </div>
                                {/* icon pulse */}
