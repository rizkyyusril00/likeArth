            ...
            <div id='home' className="hero w-full h-screen pt-[8rem] md:pt-[10rem] xl:pt-[8rem] px-[24px] overflow-hidden transition-all ease-in-out duration-500">
                <div className="container mx-auto max-w-[1120px]">
                    <div className="hero-box flex flex-col items-center justify-center gap-[1rem]">
                        ...
                        {/* contack us mobile */}
                        <motion.div whileInView={{y: [25, 0] }} transition={{delay: 0.9, duration: 1.5, ease: "easeInOut" }} viewport={{ once: true }} className='flex md:hidden justify-center items-center'>
                            <motion.div whileInView={{opacity: [0, 1] }} transition={{delay: 1, duration: 1.5, ease: "easeInOut" }} viewport={{ once: true }} className="flex items-center justify-center gap-1 md:gap-4 xl:gap-[0.625rem] bg-white pl-[0.75rem] rounded-[0.938rem] relative w-auto transition-all duration-500 ease-in-out">
                                <div className='flex items-center justify-center gap-[0.625rem]'>
                                    ...
                                    {/*attention */}
                                    <motion.p  whileInView={{opacity: [0, 1], fontSize: ['0.1rem', '0.875rem'] }} transition={{delay: 2.2, duration: 1, ease: "easeInOut" }} viewport={{ once: true }} className='py-[0.1rem] md:py-[0.6rem] leading-[28px] mr-2'><span className="text-primary">1 Slot available!</span> <span className='hidden md:inline-block text-[#676767]'>Let's talk</span> <span className='hidden xl:inline-block text-[#676767]'>to get your project started.</span></motion.p>
                                </div>
                                {/* icon pulse */}
