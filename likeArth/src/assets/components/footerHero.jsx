            ...
            <div className="footerHero w-full h-screen pt-[11.625rem] px-[24px] relative z-30">
                <div className="container mx-auto max-w-[1120px]">
                    <div className="footerHero-box flex flex-col items-center justify-center gap-[1.5rem] pt-[0.2rem] md:pt-[10rem]">
                        ...
                        <p data-aos="fade-up" data-aos-once="true" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-delay="500" className="text-[1.5rem] md:text-[2.5rem] xl:text-[1.125rem] text-primary text-center leading-[28px] md:leading-[52px]">Crafting exceptional designs that elevate your brand and captivate your audience.</p>
                        {/* poins */}
                        ...
                        <div className="flex items-center justify-center gap-1 md:gap-4 xl:gap-[0.625rem] bg-white pl-[0.75rem] rounded-[0.938rem] relative">
                            <div className='flex items-center justify-center gap-[0.625rem]'>
                                ...
                                {/*attention */}
                                <p className='py-[0.1rem] md:py-[0.7rem] leading-[28px] text-[0.7rem] md:text-[1.1rem]'><span className="text-primary">1 Slot available !</span> <span className='hidden md:inline-block'>Let's talk</span> <span className='hidden xl:inline-block'>to get your project started.</span></p>
                            </div>
                            {/* btn */}
